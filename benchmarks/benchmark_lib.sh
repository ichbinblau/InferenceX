...
run_lm_eval() {
    ...
    python3 -m lm_eval --model local-chat-completions --apply_chat_template \
      ...
      --log_samples \
      --model_args "model=${MODEL_NAME},base_url=${openai_chat_base},api_key=${OPENAI_API_KEY},eos_string=</s>,max_retries=5,num_concurrent=1,timeout=1800,tokenized_requests=False,max_length=${eval_context_len}" \
